...
def get_data(Criterion,content,n_agents,SC_num,info_all,paper_num):
    ...
    for agent in range(0,n_agents):
        ...
        info_all[agent].at[paper_num,col_decision] = final_decision
        info_all[agent].at[paper_num,col_initial] = initial_decision
        info_all[agent].at[paper_num,col_thoughts] = thoughts
